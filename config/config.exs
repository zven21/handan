...
config :handan, HandanWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: HandanWeb.ErrorHTML, json: HandanWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Handan.PubSub,
  live_view: [signing_salt: "czEzCCqX"]
...
config :handan, Handan.Mailer, adapter: Swoosh.Adapters.Local
