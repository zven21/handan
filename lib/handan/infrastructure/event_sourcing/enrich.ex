defmodule Handan.EventSourcing.Middleware.Enrich do
  @moduledoc """
  ...
  alias Handan.EventSourcing.Middleware.Enrichable
...
defprotocol Handan.EventSourcing.Middleware.Enrichable do
